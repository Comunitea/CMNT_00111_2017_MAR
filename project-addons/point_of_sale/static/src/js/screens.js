...
function openerp_pos_screens(instance, module){ //module is instance.point_of_sale
    ...
    module.ReceiptScreenWidget = module.ScreenWidget.extend({
        ...
        show: function(){
            ...
            this.initOrderClose = false;
            if (!this.pos.get('selectedOrder')._printed) {
               this.initOrderClose = true; 
               this.print();
            }
        ...
        print: function() {
           ...
           var afterPrint = function() {
              if(_this.initOrderClose){
                 _this.finishOrder();
                 _this.initOrderClose = false;
	    ...
	    if (window.matchMedia) {
            ...
            //window.onbeforeprint =  _this.finishOrder();
            //window.onafterprint = _this.finishOrder();
            //if(window.hasEventListener("afterprint")){
               window.removeEventListener("afterprint", afterPrint);
            //} 
