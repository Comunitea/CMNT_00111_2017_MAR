function openerp_pos_models(instance, module){ //module is instance.point_of_sale
    ...
    module.PosModel = Backbone.Model.extend({
        ...
        models: [
        {
            ...
            fields: ['display_name', 'list_price','price','precio_incl','pos_categ_id', 'taxes_id', 'ean13', 'default_code', 
    ...
    module.Orderline = Backbone.Model.extend({
        ...
        get_display_price: function(){
            return this.get_base_price()*1.21;
        },
    ...
    module.Order = Backbone.Model.extend({
        ...
        get_client_address: function(){
            var client = this.get('client');
            return client ? client.street + ", " + client.city + ", " + client.zip + ", " + client.state_id: "";
        },        
        get_client_vat_name: function(){
            var client = this.get('client');
            return client ? client.vat : "";
        },         
